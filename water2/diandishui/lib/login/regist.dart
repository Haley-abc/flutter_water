...
//登录页面的主体
  ...
  void registFunction() async{
    ...
    HttpRequest.request("$BASE_URL/user/registe",
        method: "post",
        data: {"name":nameController,"phone": phoneController, "password": passwordController,"sex":sexController,"head":head}).then((value) {
