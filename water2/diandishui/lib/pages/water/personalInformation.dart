  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        buildItem('手机号码', phoneFocus, phoneController, true, GlobalData.phone),
        buildItem('昵称', nameFocus, nameController, false, GlobalData.name),
        buildItem('性别', sexFocus, sexController, false, GlobalData.sex),
        buildPassword(),
        Expanded(
            child: Container(
